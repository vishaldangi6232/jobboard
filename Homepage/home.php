        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.cittumkur.org">Job Board</a>
                </div>
			...
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						...
						<li>
							<a href="../Profilers/HODProfile/index.php">Admin Login</a>
						</li>
						<li>
              ...
              <!-- <a href="http://znumerique.azurewebsites.net" target="_parent">Job Board</a> -->
				</div>
